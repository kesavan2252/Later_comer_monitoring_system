        ...
        try {
            ...
            if (data.record) {
                setScannedData({
                    ...
                    name: data.record.name ? data.record.name.trim() : "N/A",  // Trim whitespace from name
                    department: data.record.department || "Unknown",
                    date: new Date(data.record.date).toLocaleString("en-IN", { timeZone: "Asia/Kolkata" }), // Format date
            ...
            <div className="flex flex-col items-center justify-center mt-10">
                ...
                <div className="bg-white shadow-lg rounded-lg p-6 mt-6 w-96">
                    <div className={`text-lg font-bold mb-3 text-center 
                        ${hardwareStatus === "Hardware Active" ? "text-green-500" : "text-red-500"}`}>
                        {hardwareStatus}
                    </div>
